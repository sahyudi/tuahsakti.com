                            ...
                            <tbody>
                                ...
                                <?php foreach ($hutang as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="<?= base_url('project/delete_saldo_hutang/') . $value->id ?>" title="Hapus Hutang" onclick="return validation()" class="btn btn-xs btn-danger"><i class="fas fa-fw fa-trash"></i></a>
                                            <a href="<?= base_url('project/info_detail_hutang/') . $value->id ?>" class="btn btn-xs btn-primary btn-edit" title="Lihat Detail"><i class="fas fa-fw fa-info"></i></a>
                                        </td>
                                    </tr>
